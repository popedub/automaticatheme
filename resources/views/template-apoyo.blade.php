...
@section('content')
  <div class="row">
    <div class="col-12">
      <h2 class="t-bigger text-uppercase">@title</h2>
    ...
    <div class="col-12 mt-3 mb-5">
      <h3 class="t-bigger text-uppercase mb-5">{{ __('Amigues', 'automaticatheme') }}</h3>
    ...
    @php
      ...
      <div class="desplegables w-100 mb-5">
        ...
        <div class="desplegable col-12 border-top border-primary">
          <a class="d-flex align-items-center justify-content-between f-big" data-toggle="collapse" href="#apoyo{{ $i }}"
      ...
      <div class="col-12">
        ...
        <div class="row pt-5">
          @fields('logos')
          <div class="col-4 col-lg-2 d-flex algin-items-center">
